...
class BoatType1 implements CharFigure {
    ...
    private static final BackColor boatColor = BackColor.ANSI_BG_WHITE;
    ...
    public void draw(int relX, int relY) {
        stream.addChar('_',relX - 3, relY + 1,  GraphicalOcean.waveColor, GraphicalOcean.waterColor);
        stream.addChar('_',relX + 6, relY + 1,  GraphicalOcean.waveColor, GraphicalOcean.waterColor);
        ...
        stream.addColor(relX + 5, relY + 1, boatColor);
