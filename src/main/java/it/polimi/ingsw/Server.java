...
public class Server implements ServerConnectionUtils {
        ...
        try {
            ...
            if (waitingClients.size() == 0) {
                ...
                if (waitingClients.size() == 2) {
                    while (connection.getClientNickname().equals(waitingClients.get(0).getClientNickname()))
                        connection.askNicknameAgain();
                } else {
                    while (connection.getClientNickname().equals(waitingClients.get(0).getClientNickname()) || connection.getClientNickname().equals(waitingClients.get(1).getClientNickname()))
                        connection.askNicknameAgain();
                }
