...
public class BoatType3 extends GraphicalBoat{
    ...
    public void draw(int relX, int relY) {
        ...
        stream.addColor(relX - 1, relY + 1, null, BackColor.ANSI_BRIGHT_BG_BLACK);
        stream.addColor(relX, relY + 1, null, BackColor.ANSI_BRIGHT_BG_BLACK);
        stream.addColor(relX + 1 , relY + 1, null, BackColor.ANSI_BRIGHT_BG_BLACK);
        stream.addColor(relX + 2, relY + 1, null, BackColor.ANSI_BRIGHT_BG_BLACK);
        stream.addColor(relX + 3, relY + 1, null, BackColor.ANSI_BRIGHT_BG_BLACK);
        stream.addColor(relX + 4, relY + 1, null, BackColor.ANSI_BRIGHT_BG_BLACK);
