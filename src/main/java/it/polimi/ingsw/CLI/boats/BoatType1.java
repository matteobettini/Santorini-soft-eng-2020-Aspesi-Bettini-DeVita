...
class BoatType1 implements CharFigure {
    ...
    public void draw(int relX, int relY) {
        ...
        stream.addColor(relX - 2, relY + 1, BackColor.ANSI_BG_WHITE);
        stream.addColor(relX - 1, relY + 1, BackColor.ANSI_BG_WHITE);
        stream.addColor(relX, relY + 1, BackColor.ANSI_BG_WHITE);
        stream.addColor(relX + 1 , relY + 1, BackColor.ANSI_BG_WHITE);
        stream.addColor(relX + 2, relY + 1, BackColor.ANSI_BG_WHITE);
        stream.addColor(relX + 3, relY + 1, BackColor.ANSI_BG_WHITE);
        stream.addColor(relX + 4, relY + 1, BackColor.ANSI_BG_WHITE);
        stream.addColor(relX + 5, relY + 1, BackColor.ANSI_BG_WHITE);
